            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   <div class="form-group has-feedback">
                       ...
                       <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="busquedakardexproducto" id="busquedakardexproducto" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Descripción del Producto para tu Búsqueda" autocomplete="off" required="" aria-required="true"/>  
