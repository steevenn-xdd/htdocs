            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   <div class="form-group has-feedback">
                       ...
                       <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="busquedakardexcombo" id="busquedakardexcombo" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Descripción del Combo para tu Búsqueda" autocomplete="off" required="" aria-required="true"/>  
