...
function AsignaObservacion(codigo,tipo,cantidad,observacion,salsa)
{
  ...
  $("#agregaobservaciones #agrega_detalle_observacion").load("detalles_delivery?BuscaDetallesProductoxObservacion=si&d_codigo="+codigo+"&d_tipo="+tipo+"&d_cantidad="+cantidad+"&d_observacion="+observacion+"&d_salsa="+salsa);
}
// ####################### FUNCION PARA ASIGNAR OBSERVACION A DETALLES #######################
...
function AsignaSalsa(codigo,tipo,cantidad,observacion,salsa)
{
  ...
  $("#agregasalsas #agrega_detalle_salsa").load("detalles_delivery?BuscaDetallesProductoxSalsa=si&d_codigo="+codigo+"&d_tipo="+tipo+"&d_cantidad="+cantidad+"&d_observacion="+observacion+"&d_salsa="+salsa);
}
// ####################### FUNCION PARA ASIGNAR SALSAS A DETALLES #######################
        ...
        if (e.charCode == 13 || e.keyCode == 13) { //ENTER
            ...
            if (code == "") {
                ...
                "<tr class='warning-element' style='border-left: 2px solid #ffb22b !important; background: #fefde3;'>" +
                    ...
                    "<td width='12%' class='m-t-0'><h6 class='alert-link'>" + item.precio2 + "</h6></td>" +
                    "<td width='14%' class='m-t-0'><h6 class='alert-link'>" + Operacion.toFixed(2) + "</h6></td>" +
